...
namespace ST2Prj2LibNI_DAQ
{
    ...
    {
        private List<double> currentVoltageSeqPrivate
            ; //Last voltage seqeunce collected, numbers according til value of totalSamples

        //private int totalSamples = 2500;       //Global container for the number of samples to acquire
        private AnalogWaveform<double>[] data; //NI DAQ internal datamodel
        ...
        /// </summary>
        public double[] currentVoltageSeqArray => currentVoltageSeqPrivate.ToArray();

        /// <summary>
        ///     Gives a copy of the latest sequence of voltage meassurings
        /// </summary>
        public List<double> currentVoltageSeq => new List<double>(currentVoltageSeqPrivate);
        ...
        ///     currentVoltageSeq that returns a copy List
        ///     <double>
